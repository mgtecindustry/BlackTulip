...
export default function HeroSection1() {
  return (
    <section className="grid lg:flex items-center justify-center  max-w-7xl mx-auto pt-12">
      ...
      <div className="flex-1 max-w-7xl lg:max-w-xl">
        <Image
          ...
          className="w-full h-[40vh] sm:h-[50vh] lg:h-[60vh] opacity-90 object-cover "
        />
      </div>

      {/* Secțiunea de text */}
      <div className="text-center lg:text-left flex-1 max-w-7xl lg:max-w-xl px-8">
